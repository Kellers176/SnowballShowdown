...
namespace NewtonVR
{
    public class NVRInteractableItem : NVRInteractable
    {
        ...
        //public GameObject leftHandHoldPos;
        //public GameObject rightHandHoldPos;
        ...
        public override void BeginInteraction(NVRHand hand)
        {
            ...
            if(hand.IsLeft)
            {
                pickupTransform.position = GameObject.Find("HoldPositionLeft").transform.position;
            }
            else if (hand.IsRight)
            {
                pickupTransform.position = GameObject.Find("HoldPositionRight").transform.position;
            }
            //pickupTransform.position = this.transform.position;
            // Vector3 temp = pickupTransform.position;
            //temp.y = pickupTransform.position.y + 0.1f;
            //pickupTransform.position = hand.transform.position;
            //pickupTransform.position = leftHandHoldPos.transform.position;
