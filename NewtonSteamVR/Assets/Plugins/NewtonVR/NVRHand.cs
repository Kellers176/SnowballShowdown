...
namespace NewtonVR
{
	...
	float timeBetweenHits = 0.3f;
        ...
        void RaycastToHand()
        {
            ...
            //if (hit.transform.GetComponent<NVRInteractable>().tag == "Snowblower")
            //{
            ...
            if (hit.transform.GetComponent<NVRInteractableItem>())
            {
                ...
                if (IsLeft)
                {
                    ...
                    raycastObjectLeft.transform.position = Vector3.Lerp(hit.transform.position, GameObject.Find("HoldPositionLeft").transform.position, fracJourney);
                    // raycastObject.transform.position = GameObject.Find("HoldPositionLeft").transform.position;
                    raycastObjectLeft.transform.position = GameObject.Find("HoldPositionLeft").transform.position;
                ...
                else if (IsRight)
                {
                    ...
                    raycastObjectRight.transform.position = Vector3.Lerp(hit.transform.position, GameObject.Find("HoldPositionRight").transform.position, fracJourney);
